default[:hadoop2][:version] = "2.4.0"
default[:hadoop2][:pig][:version] = "0.12.1"

default[:hadoop2][:rack_id] = nil # defaulted to node[:hadoop][:rack_id] || "/#{node.cluster_name}/default"
...
default[:hadoop2][:zk][:cluster] = nil # defaulted to node.cluster_name by recipe
default[:hadoop2][:hdfs][:cluster] = nil # if the cluster has no namenodes, set this to pick a default one (defaults to first avail)

default[:hadoop2][:historyserver] = nil # will autodetect, use this to override
...
default[:hadoop2][:hive][:repository] = "https://github.com/liquidm/hive.git"
default[:hadoop2][:hive][:revision] = "master"
