...
<li>
<a href="<?php echo $cfg["cgi_base_url"];?>/status.cgi?host=all&amp;type=detail&amp;serviceprops=270378&amp;servicestatustypes=24" target="<?php echo $link_target;?>">Problems</a>
<ul>
<li>
<a href="<?php echo $cfg["cgi_base_url"];?>/status.cgi?host=all&amp;type=detail&amp;serviceprops=270378&amp;servicestatustypes=24" target="<?php echo $link_target;?>">Unhandled</a>
</li>
<li>
<a href="<?php echo $cfg["cgi_base_url"];?>/status.cgi?host=all&amp;type=detail&amp;serviceprops=262178&amp;servicestatustypes=28" target="<?php echo $link_target;?>">All Problems</a>
</li>
<li>
