...
timeout <%= node[:gitlab][:unicorn][:timeout] %>

# Help ensure your application will always spawn in the symlinked
# "current" directory that Capistrano sets up.
working_directory "/var/lib/git/gitlab/current"

# Location of the pidfile. Should not be changed unless you
# know what you are doing.
pid "/var/lib/git/gitlab/shared/pids/unicorn.pid"

# listen on Unix domain socket and let nginx proxy
listen "/var/lib/git/gitlab/shared/pids/unicorn.sock"
...
before_exec do |server|
  ENV["BUNDLE_GEMFILE"] = "/var/lib/git/gitlab/current/Gemfile"
end
...
before_fork do |server, worker|
  ...
  old_pid = "/var/lib/git/gitlab/shared/pids/unicorn.pid.oldbin"
