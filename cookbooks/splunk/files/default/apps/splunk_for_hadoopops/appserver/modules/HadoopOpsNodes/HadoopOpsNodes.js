Splunk.Module.HadoopOpsNodes = $.klass(Splunk.Module.DispatchingModule, {
        ...
        for (i=0; i < services.length; i++) { 
            ...
            if (stat === 0 && service_down === false) {
                ...
                selection.append("svg:image")
                    .attr("xlink:href", Splunk.util.make_url("/modules/HadoopOpsNodes/down_node_icon_35x35.png"))
