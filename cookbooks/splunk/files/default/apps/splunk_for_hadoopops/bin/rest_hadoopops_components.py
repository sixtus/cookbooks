...
required_args = ['host', 'service', 'monitored']
optional_args = ['description', 'created_at']

ENDPOINT = 'admin/conf-components'

class HadoopOpsComponentsHandler(admin.MConfigHandler):
